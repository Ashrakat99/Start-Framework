  ...
  return (
    <div>
      <div className="pt-4 text-center ">
        <h2 className="text-4xl font-extrabold my-10 text-[#2c3e50] text-uppercase pt-16">Contact Component</h2>
      ...
      <form className="w-1/2 p-6 mx-auto mt-10 bg-white rounded-lg" noValidate>
      <div className="mb-4">
      ...
      <button
        type="submit"
        className=" p-2 bg-[#1ABC9C] text-white font-semibold rounded-md hover:bg-teal-600 transition duration-200">
        Send Message
      </button>
    </form>
    </div>
